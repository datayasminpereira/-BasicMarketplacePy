...
def cadastrar_produto() -> None:
    ...
    preco: float = float(input('Informe o preço desse produto: '))
...
def comprar_produto() -> None:
    if len(produtos) > 0:
        print('Informe o código do produto que se deseja adicionar no carrinho: ')
        print('-----------------------------------------------------------------')
...
def visualizar_carrinho() -> None:
    if len(carrinho) > 0:
        ...
        print('Ainda não existe produtos no carrinhho!')
    sleep(2)
    menu()
